        ...
        {matrix.flatMap((row, rowIndex) =>
          row.map((value, colIndex) => (
            <div
              ...
              title={`Row ${rowIndex + 1}, Col ${colIndex + 1} â€¢ ${valueLabel}: ${value.toFixed(6)}`}
            />
          ))
        )}
      </div>
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-0.5">Dashboard â€” Analysis Results</p>
        </div>
        <motion.button
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <SurfaceHeatmap
          title="1ï¸âƒ£ Input Volatility Surface"
          matrix={inputMatrix}
          min={volMin}
          max={volMax}
          hue={190}
        ...
        <SurfaceHeatmap
          title="2ï¸âƒ£ Predicted Volatility Surface"
